      ...
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="form-group row">
               <label for="name" class="col-lg-3 col-md-3 col-3">User Name:</label>
               <div class="col-9">
                  <input type="text" class="form-control" id="name" name="name" value="@if(isset($objData->name)){{ $objData->name }}@endif" placeholder="User Name" maxlength="50" required autofocus>
               </div>
            </div>
            <div class="form-group row">
               <label for="username" class="col-lg-3 col-md-3 col-3">Login ID:</label>
               <div class="col-9">
