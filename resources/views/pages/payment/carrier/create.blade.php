          ...
          <div class="col-md-6">
             <div class="form-group row">
                ...
                <div class="col-lg-9 col-md-9 col-9">
                   <input type="date" class="form-control" id="invoice_date" name="invoice_date" value="{{ date('Y-m-d') }}" placeholder="Invoice Date" required autofocus>
                </div>
             </div>
             <div class="form-group row">
             ...
             <div class="form-group row">
                ...
                <div class="col-7">
                   <input type="number" class="form-control" id="invoice_tax" name="invoice_tax" value="0.00" placeholder="Invoice Tax" required>
                </div>
                <div class="col-2">
             ...
             <div class="form-group row">
                ...
                <div class="col-lg-9 col-md-9 col-9">
                   <input type="number" class="form-control" id="invoice_total" name="invoice_total" value="@if(isset($objData->order->total_charges)){{ $objData->order->total_charges }}@endif" placeholder="Invoice Total" required>
                </div>
             </div>
          </div>
          <div class="col-md-6">
             ...
             <div class="form-group row">
                ...
                <div class="col-lg-9 col-md-9 col-9">
                   <textarea name="invoice_orders" id="invoice_orders" class="form-control">@if(isset($objData->order->id)){{ $objData->order->id }}@endif</textarea>
                </div>
             </div>
          </div>
          <div class="col-md-12">
