                  ...
                  <div class="row align-items-center">
                     <div class="col-lg-8 col-md-10 col-12">
                        ...
                        <div class="form-group row mb-1">
                              ...
                              <input class="col-lg-7 col-md-7 col-6" type="text" name="filter"/>
                        </div>
                     </div>
            ...
            columns: [
               {data: 'id', name:'id',
                ...
                {data: 'customer', name:'customer', class:'tooltip-td',
                    "render": function ( data, type, row, meta ) {
                        return '<button class="tooltip-btn"><img src="'+ASSET_URL+'admin/images/tooltip.png" class="tooltip-img"></button><span class="classic detailss">Contact: <span class="conatct">'+row.customer.contact+'</span><br> Phone: <span class="phone">'+row.customer.phone+'</span><br> Fax: <span class="fax">'+row.customer.fax+'</span></span>'+row.customer.company;
                    }
                },
                {data: 'address', name:'address',
                    "render": function ( data, type, row, meta ) {
                        return '<span><img src="'+ASSET_URL+'admin/images/view_from.gif" class="view">'+row.address.to_city+','+row.address.to_state+','+row.address.to_country+'</span><br><span><img src="'+ASSET_URL+'admin/images/view_to.gif" class="view">'+row.address.from_city+','+row.address.from_state+','+row.address.from_country+'</span></td>';
                    }
                },
